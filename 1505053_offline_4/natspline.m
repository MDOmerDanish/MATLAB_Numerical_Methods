...
%(continued)
%FIGURE 18.12
%M-file to determine intermediate values and derivatives with a natural spline. Note that the diff
%function employed for error trapping is described in Section 21.7.1.
%18.7 CASE STUDY continued
%454 SPLINES AND PIECEWISE INTERPOLATION
